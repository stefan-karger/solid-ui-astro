...
const rawConfigPatchSchema = z
  .object({
    ...
    tailwind: z
      ...
      .optional(),
    iconLibrary: z.string().optional(),
    rtl: z.coerce.boolean().optional(),
    menuColor: z.enum(["default", "inverted"]).optional(),
...
type CssValue = string | Array<string | Record<string, string>> | CssObject
...
export const registryItemSchema = z.discriminatedUnion("type", [
  registryItemCommonSchema.extend({
    ...
    config: rawConfigPatchSchema.optional()
  }),
  registryItemCommonSchema.extend({
