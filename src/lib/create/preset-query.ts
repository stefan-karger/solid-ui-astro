import { V1_CHART_COLOR_MAP, type PresetConfig } from "~/lib/create/preset"
import { type ChartColorName, type FontHeadingValue } from "~/lib/create/types"
...
export function resolvePresetOverrides(
  ...
  const chartColor = hasChartColorOverride
    ...
    : ((decoded.chartColor ?? V1_CHART_COLOR_MAP[decoded.theme] ?? decoded.theme) as ChartColorName)
